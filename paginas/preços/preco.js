...
function qrCode(){
    ...
    if(precofinal == 100){
        qrcode.setAttribute('src', './qrcodes/1.jpg')
    }
    if(precofinal == 200){
        qrcode.setAttribute('src', './qrcodes/2.jpg')
    }

    if(precofinal == 300){
        qrcode.setAttribute('src', './qrcodes/3.jpg')
    }

    if(precofinal == 400){
        qrcode.setAttribute('src', './qrcodes/4.jpg')
    }
    if(precofinal == 500){
        qrcode.setAttribute('src', './qrcodes/5.jpg')
    }
    if(precofinal == 600){
        qrcode.setAttribute('src', './qrcodes/6.jpg')
    }
